                        ...
                        <div className="col-md-12 text-center">
                            ...
                            <div className="col-lg-6 col-md-offset-3">
                                <div className="input-group subscription-form">
                                    <input type="text" className="form-control" placeholder="Ingrese su dirección de correo electrónico"/>
                                        <span className="input-group-btn">
                                            <button className="btn btn-main" type="button">Suscríbete Ahora!</button>
                                        </span>
                                </div>
                            </div>
